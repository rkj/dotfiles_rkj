# Auto-generated by save-tide-config.fish — do not edit by hand.
# Re-generate with: fish scripts/save-tide-config.fish
...
set -U tide_vcs_dir_bg_color 4E9A06
set -U tide_vcs_dir_color 000000
